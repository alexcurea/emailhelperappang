...
export class NewslettersComponent implements OnInit {
  ...
  sendNewsLetter() {
    let _content: String = this.newsletterForm.controls['content'].value;
    this.newsletterForm.patchValue({
      content: emailContent + _content + emailContent2
    });
  ...
  getContent(content: string){
    // console.log(content.slice(7382, -1015));
    return content.slice(5070, -856);
  }

  loadData(){
    this.newsletterService.fetchNewsletters().subscribe((newsletters)=>{
